...
4. Wittgenstein says: look at what we actually call "games" — ring-around-the-rosy, chess, tennis, solitaire — and you will find no single shared feature, only a criss-crossing network of similarities. If he is right, is the philosophy of sport even possible? Or is it just a debate about how to draw an arbitrary line?

5. Is there a meaningful distinction between **play** and **sport**? Some candidates:
   - Sport requires rules; play does not
   - Sport requires competition; play does not
   - Sport requires physical skill; play does not
   - Sport is institutionalized; play is spontaneous
   Which of these, if any, actually does the work? Can you construct a counterexample to each?

6. Professional athletes are paid to compete. They have contracts, obligations, performance targets. Are they *playing* in any meaningful sense? Has professional sport abolished play — or does it represent play's highest expression?
...
**On Play, Game, Sport (10 min)**

21. The World Cup is contested between *nations*, not clubs or individuals. National teams carry an identity that goes far beyond sport — they represent histories, colonial legacies, political conflicts, and cultural pride. Does this mean the World Cup is *more than* a sport — a ritual, a political event, a form of collective identity performance? And if so, does that change its relationship to play? Is there anything still *playful* about the World Cup?

22. VAR (Video Assistant Referee) technology was introduced to reduce refereeing error and produce more "correct" decisions. It has instead produced one of the sharpest philosophical debates in modern sport: should the offside rule — designed to encourage open, attacking play — be applied to the millimeter, disallowing goals because a player's armpit was fractionally ahead of the last defender? What does VAR reveal about the relationship between the *letter* and the *spirit* of rules? Is there a right answer here, philosophically?
